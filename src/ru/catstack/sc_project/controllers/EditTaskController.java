...
public class EditTaskController extends GController implements HavingImage {
    ...
    public void onShow() throws Exception {
        ...
        if (Core.userInfo.getThisTask().getImageFile() != null) {
            taskImage.setImage(ImageUtils.getAssetsImage(Core.userInfo.getThisTask().getImageFile()));
            imagePath = Core.userInfo.getThisTask().getImageFile();
        } else {
            setBlankImage();
        }
    }
    ...
    public void onSaveClick(ActionEvent actionEvent) {
        ...
        Core.userInfo.getThisTask().setImageFile(imagePath);
